...
_OPENCODE_GO_MODELS = [
    ...
    Model(
        ...
        name="MiniMax M2.7",
        description="OpenCode Go curated MiniMax M2.7 model over the chat completions endpoint",
        capabilities=["tool_use", "thinking", "structured_output", "stream"],
        max_context_token=265_000,
        default=False,
        input_token_price_1m=0.0,
    ...
    Model(
        ...
        service_name="opencode_anthropic",
        name="MiniMax M2.5",
        description="OpenCode Go curated MiniMax M2.5 model over the chat completions endpoint",
        capabilities=["tool_use", "thinking", "structured_output", "stream"],
        max_context_token=265_000,
        default=False,
        input_token_price_1m=0.0,
    ...
    Model(
        ...
        provider="opencode_go",
        name="DeepSeek V4 Pro",
        description="OpenCode Go curated DeepSeek V4 Pro model over the chat completions endpoint",
        capabilities=["tool_use", "thinking", "structured_output", "stream"],
        max_context_token=1_000_000,
        default=False,
        input_token_price_1m=0.0,
    ...
    Model(
        ...
        provider="opencode_go",
        name="DeepSeek V4 Flash",
        description="OpenCode Go curated DeepSeek V4 Flash model over the chat completions endpoint",
